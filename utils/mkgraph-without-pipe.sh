...
#Please change the following path to a location with enough disk space.
langg="/home"
...
# If $lang/tmp3-394/LG.fst does not exist or is older than its sources, make it...
...
mkdir -p $langg/tmp3-394
# Note: [[ ]] is like [ ] but enables certain extra constructs, e.g. || in 
# place of -o
if [[ ! -s $langg/tmp3-394/LG.fst || $langg/tmp3-394/LG.fst -ot $lang/G.fst || \
      $langg/tmp3-394/LG.fst -ot $lang/L_disambig.fst ]]; then

fsttablecompose $lang/L_disambig.fst $lang/G.fst $langg/tmp3-394/LG1.fst

fstdeterminizestar --use-log=true $langg/tmp3-394/LG1.fst $langg/tmp3-394/LG2.fst

fstminimizeencoded $langg/tmp3-394/LG2.fst $langg/tmp3-394/LG3.fst

fstarcsort --sort_type=ilabel $langg/tmp3-394/LG3.fst $langg/tmp3-394/LG.fst

#  fsttablecompose $lang/L_disambig.fst $lang/G.fst | fstdeterminizestar --use-log=true | \
#    fstminimizeencoded | fstarcsort --sort_type=ilabel > $lang/tmp3-394/LG.fst || exit 1;

  fstisstochastic $langg/tmp3-394/LG.fst || echo "[info]: LG not stochastic."
fi


clg=$langg/tmp3-394/CLG_${N}_${P}.fst

if [[ ! -s $clg || $clg -ot $langg/tmp3-394/LG.fst ]]; then
  fstcomposecontext --context-size=$N --central-position=$P \
   --read-disambig-syms=$lang/phones/disambig.int \
   --write-disambig-syms=$langg/tmp3-394/disambig_ilabels_${N}_${P}.int \
    $langg/tmp3-394/ilabels_${N}_${P} < $langg/tmp3-394/LG.fst |\
...
if [[ ! -s $dir/Ha.fst || $dir/Ha.fst -ot $model  \
    || $dir/Ha.fst -ot $langg/tmp3-394/ilabels_${N}_${P} ]]; then
  if $reverse; then
    make-h-transducer --reverse=true --push_weights=true \
      --disambig-syms-out=$dir/disambig_tid.int \
      --transition-scale=$tscale $langg/tmp3-394/ilabels_${N}_${P} $tree $model \
      > $dir/Ha.fst  || exit 1;
  else
...
#  fstisstochastic $dir/HCLGa.fst || echo "HCLGa is not stochastic"
  ...
  fsttablecompose $dir/Ha.fst $clg $dir/A1.fst
  fstdeterminizestar --use-log=true $dir/A1.fst $dir/A2.fst
  fstrmsymbols $dir/disambig_tid.int $dir/A2.fst $dir/A3.fst
  fstrmepslocal $dir/A3.fst $dir/A4.fst 
  fstminimizeencoded $dir/A4.fst $dir/HCLGa.fst || exit 1;
  fstisstochastic $dir/HCLGa.fst || echo "HCLGa is not stochastic"
